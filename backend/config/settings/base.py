...
# SEPay
SEPAY_BANK_ACCOUNT = env("BANK_ACCOUNT", default="")
SEPAY_BANK_CODE = env("BANK_NAME", default="")
SEPAY_PRE_DESCRIPTION = env("PRE_DESCRIPTION", default="MICROMENTOR")
SEPAY_WEBHOOK_API_KEY = env("SEPAY_WEBHOOK_API_KEY", default="")
