...
# SEPay
SEPAY_BANK_ACCOUNT = env("SEPAY_BANK_ACCOUNT", default="")
SEPAY_BANK_CODE = env("SEPAY_BANK_CODE", default="")
SEPAY_PRE_DESCRIPTION = env("SEPAY_PRE_DESCRIPTION", default="MICROMENTOR")
