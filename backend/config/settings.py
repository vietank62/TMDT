...
AZURE_STORAGE_CONTAINER = config('AZURE_STORAGE_CONTAINER', default='uploads')
...
# SEPay
SEPAY_API_KEY = config('SEPAY_API_KEY', default='')
SEPAY_WEBHOOK_SECRET = config('SEPAY_WEBHOOK_SECRET', default='')
