...
import { signUp, signInWithGoogle, getFirebaseErrorMessage } from '@/lib/firebase-auth'
...
export default function SignUpPage() {
  ...
  return (
    <div>
      ...
      <Button variant="outline" className="w-full" type="button" onClick={handleGoogleSignUp} disabled={googleLoading}>
