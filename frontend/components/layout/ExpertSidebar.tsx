...
export default function ExpertSidebar() {
  ...
  const pendingCount = getPendingBookingsForExpert('expert-1').length
      ...
      <div className="p-4 border-b">
        <div className="flex items-center gap-3">
          <Avatar className="h-10 w-10">
            <AvatarImage src="https://api.dicebear.com/7.x/avataaars/svg?seed=nduc&backgroundColor=c0aede" />
            <AvatarFallback>ND</AvatarFallback>
          </Avatar>
          <div className="overflow-hidden">
            <p className="font-semibold text-sm truncate">Nguyễn Minh Đức</p>
            <p className="text-xs text-green-600 font-medium">Chuyên gia đã duyệt</p>
          </div>
        </div>
      </div>
